...
def test_full_volume(setup_transposed_volume_service):
    raw_volume, volume_config, _full_from_h5, _h5_reader = setup_transposed_volume_service
...
def test_multiscale(setup_transposed_volume_service):
    _raw_volume, volume_config, _full_from_h5, _h5_reader = setup_transposed_volume_service
...
if __name__ == "__main__":
    pytest.main(['-s', '--tb=native', '--pyargs', 'tests.volumes.test_transposed_volume_service'])
