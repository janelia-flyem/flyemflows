...
def _run_and_check_scale_0(setup):
...
def test_copygrayscale_from_dvid_to_dvid(setup_dvid_grayscale_input):
    _box_zyx, _expected_vol = _run_and_check_scale_0(setup_dvid_grayscale_input)
  
  
def test_copygrayscale_from_hdf5_to_dvid(setup_hdf5_grayscale_input):
    _box_zyx, _expected_vol = _run_and_check_scale_0(setup_hdf5_grayscale_input)
...
def test_copygrayscale_from_hdf5_to_dvid_multiscale(setup_hdf5_grayscale_input):
    ...
    box_zyx, scale_0_vol = _run_and_check_scale_0( setup_hdf5_grayscale_input )
